...
import 'package:airhost_lint_plugin/mirror_visitor.dart';
import 'package:airhost_lint_plugin/utils/map_utils.dart';
...
class MirrorPlugin extends ServerPlugin with FixesMixin, DartFixesMixin {
  ...
  List<FixContributor> getFixContributors(String path) {
    return <FixContributor>[/*MyFixContributor(path)*/];
  }
}
